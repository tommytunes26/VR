...
function(t,e){
    ...
    if (selected == "/vr/vr-htc.html") {
            $("#1").addClass("selected");
                
    } else if (selected == "/vr/vr-oc.html") {
            $("#2").addClass("selected");
                
    } else if (selected == "/vr/vr-form.html") {
            $("#3").addClass("selected");
